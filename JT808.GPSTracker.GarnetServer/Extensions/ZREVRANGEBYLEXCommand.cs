...
{
    public class ZREVRANGEBYLEXCommand : CustomTransactionProcedure
    {
        ...
        public override void Finalize<TGarnetApi>(TGarnetApi api, ArgSlice input, ref MemoryResult<byte> output)
        {
            ...
            api.SortedSetRange(key, min, max, SortedSetOrderOperation.ByLex, out var outputvalues, out _, reverse: true);
